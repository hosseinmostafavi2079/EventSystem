        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-20">
                ...
                <div className="flex items-center gap-3">
                    <button className="hidden md:block text-gray-600 hover:text-gray-900 font-bold text-sm px-4 py-2">
                        ورود
                    </button>
                    <button className="bg-gray-900 text-white px-5 py-2.5 rounded-xl font-bold text-sm hover:bg-gray-800 transition shadow-md hover:shadow-lg transform hover:-translate-y-0.5 active:translate-y-0">
                        ثبت‌نام رایگان
                    </button>
                </div>
            </div>
